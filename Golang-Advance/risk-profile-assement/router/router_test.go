...
import (
	...
	mock_handler "github.com/susilo001/golang-advance/risk-profile-assement/mock/handler"
...
func TestSetupRouter(t *testing.T) {
	...
	mockSubmissionHandler:= mock_handler.NewMockISubmissionHandler(ctrl)
	...
	router.SetupRouter(r, mockUserHandler,mockSubmissionHandler)
